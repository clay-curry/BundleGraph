	...
	switch (settings.monacoSource) {
		...
		case "independent":
			...
			switch (settings.languagesSource) {
				case "latest":
					languagesUrl = `${root}/languages/bundled/amd-${settings.latestLanguagesStability}/vs`;
					break;
				case "source":
					languagesUrl = `${root}/languages/amd-tsc`;
					break;
				case "url":
			...
			Object.assign(setup.loaderConfigPaths, {
				"vs/fillers/monaco-editor-core": `${root}/languages/amd-tsc/fillers/monaco-editor-core-amd`,
...
export function getDefaultSettings(): Settings {
	const defaultSettings: Settings = {
		...
		languagesUrl: "http://localhost:5002/languages/amd-tsc",
